...
public class RequestParams {
    ...
    public RequestParams addJustKeyParameter(String key){
        try {
            params.put(key, URLEncoder.encode("", "UTF-8"));
    ...
    public void encodePostParameters(HttpURLConnection connection) throws IOException { // Exception will be caught in the Async task
